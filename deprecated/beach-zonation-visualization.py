# Beach Zonation Microplastics Visualization
# This script creates a publication-quality visualization of microplastic distribution
# across different beach zones using the Taiwan beach data
